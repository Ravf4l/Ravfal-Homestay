...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2022 at 07:47 AM
...
(21, 'Hakim', '1234', 'hakim@gmail.com', 'Male', '087876547902', 'Indonesia');
...
(11, 21, 23, '2021-05-03', '2000000', '1620009459.png', 'Not Payed', 'Mei');
...
(21, 'M1', '1', 'a single bed, mattress, a bed sheet, a pillow, a pillow case, a desk, a chair, a cabinet, 1 light bulb, 1 air conditioner, a trash can, a window, and a private bathroom.', 'used | Randy', 1000000),
...
(23, 'M3', '1', 'a single bed, mattress, a bed sheet, a pillow, a pillow case, a desk, a chair, a cabinet, 1 light bulb, 1 air conditioner, a trash can, a window, and a private bathroom.', 'used | Hakim', 1000000),
...
(30, 'M10', '2', 'a single bed, mattress, a bed sheet, a pillow, a pillow case, a desk, a chair, a cabinet, 1 light bulb, 1 air conditioner, a trash can, a window, and a private bathroom.', 'used | David', 1000000),
...
(33, 'W3', '1', 'a single bed, mattress, a bed sheet, a pillow, a pillow case, a desk, a chair, a cabinet, 1 light bulb, 1 air conditioner, a trash can, a window, and a private bathroom.', 'used | Raisa', 1000000),
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `rent`
  MODIFY `rent_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `room`
  MODIFY `id_room` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
